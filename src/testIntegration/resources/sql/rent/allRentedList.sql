...
INSERT INTO public.rents (id, user_id, vehicle_id,end_time, return_time,start_time) VALUES
('0f60fcc9-f104-4dce-93c4-ea2648fb3571','b71ee839-bcb4-4a86-9e62-1e8df0683c8c',
    '1c7fcfd7-423b-4742-a20c-49cba845bf2f',(now()::timestamp + interval '2 hour'),
    (now()::timestamp + interval '4 hour'), now()::timestamp);
